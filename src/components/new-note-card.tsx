                    ...
                    <form  className="flex-1 flex flex-col">
                        ...
                        {isRecording ? (
                            <button
                                ...
                                className="w-full flex item-center justify-center gap-2 bg-slate-900 py-4 text-center text-sm text-slate-300 outine-none font-medium hover:text-slate-100"
                                >
                        ...
                        className="w-full bg-lime-400 py-4 text-center text-sm text-lime-950 outine-none font-medium hover:bg-lime-500"
                        >
                            Salvar nota
                        </button>
                        ) }
